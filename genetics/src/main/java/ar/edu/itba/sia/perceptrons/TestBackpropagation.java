...
public class TestBackpropagation {
	...
	public static void main(String[] args) {
		...
		List<Layer> layers = new ArrayList<Layer>(architecure.length - 2);
		...
		for (int i = 1; i < architecure.length; i++) {
			layers.add(new Layer(DoubleMatrix.rand(architecure[i],architecure[i-1] + 1), new TanhMatrixFunction()));
		}
